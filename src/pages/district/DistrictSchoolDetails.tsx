    ...
    <AdminLayout variant="district">
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Natijasi bor</CardTitle>
        ...
        <Tabs defaultValue="results" className="space-y-4">
          ...
          <TabsContent value="registered" className="space-y-4">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <h2 className="text-xl font-semibold">Ro'yxatdan o'tgan o'quvchilar</h2>
                    ...
                    filteredResults.map((user) => {
                      ...
                      return (
                        <TableRow key={user.id}>
                          ...
                          <TableCell className="text-center">
                            <Badge variant={
                              (user.total_point || 0) >= 150 ? "default" :
                              (user.total_point || 0) >= 100 ? "secondary" : "destructive"
                            }>
